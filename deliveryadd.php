...
?>
      ...
      <div class="row">
        ...
        <h3 class="animated wow slideInLeft" data-wow-delay=".5s">Your shopping cart contains:
           <span><?php echo $numProduct; if($numProduct > 1) { ?> Products <?php }else {?> Product <?php } ?></span></h3>
...
<form class="card-body" action="index.php?page=confirmdelivery" method="post">
          ...
          $row = $result->fetch_assoc();
              ...
              <div class="md-form input-group pl-0 mb-5">
                ...
                aria-describedby="basic-addon1" value="<?php echo $_SESSION['scus_name']=$row['customer_name']; ?>" id="customername">
              </div>

              <!--email-->
              <div class="md-form mb-5">
                <input type="text" id="email" class="form-control" placeholder="youremail@example.com" 
                value="<?php echo $_SESSION['semail']=$row['email']; ?>" id="email">
